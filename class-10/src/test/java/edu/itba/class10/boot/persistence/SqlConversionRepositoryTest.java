...
class SqlConversionRepositoryTest {
	...
	void retrievesAllConversions() {
		...
		this.sqlExchangePersistence.save(singleConversionEntity1);
		...
		this.sqlExchangePersistence.save(singleConversionEntity2);

		final var allConversions = this.sqlExchangePersistence.findAll();
		assertThat(allConversions.size(), is(2));
		assertThat(allConversions.get(0), is(singleConversionEntity1));
		assertThat(allConversions.get(1), is(singleConversionEntity2));
	}
}
